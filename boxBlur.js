...
// black and white photo of you that is about to go viral.
//  You cannot let this ruin your reputation, so you want to apply box blur algorithm to the photo to hide its content.

// The algorithm works as follows: each pixel x in the resulting image has a value equal
//  to the average value of the input image pixels'
